...
function verifica_boleto() {
	var campo = jQuery('input[name=boleto_bradesco]').parent().parent().parent();
...
function verifica_cartao() {
	var campo = jQuery('input[name=cartao_visa],input[name=cartao_master],input[name=cartao_hipercard],input[name=cartao_diners],input[name=cartao_amex]').parent().parent().parent();
...
function verifica_debito() {
	var campo = jQuery('input[name=debito_bb],input[name=debito_bradesco],input[name=debito_banrisul],input[name=debito_itau]').parent().parent().parent();
